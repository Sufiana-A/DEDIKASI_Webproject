            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown me-2">
                    ...
                    <div class="dropdown-menu notifications">
                        <div class="topnav-dropdown-header">
                            <span class="notification-title">Pengumuman</span>
                                    ...
                                    <a href="#">
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">Admin</span> telah memasukkan anda ke dalam kelas <span class="noti-title"> Data Science </span></p>
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('profile_peserta') }}">My Profile</a>
