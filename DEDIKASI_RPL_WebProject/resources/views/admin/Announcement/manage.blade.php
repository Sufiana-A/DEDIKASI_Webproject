                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search by ID" name="uuid" value="{{ request()->uuid ?? '' }}">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search by Name" name="title" value="{{ request()->title ?? '' }}">
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="{{ route('admin.manage.add') }}" class="btn btn-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="subject_id">{{ $announcement->uuid }}</td>
                                        <td>
                                            <h2>
                                        ...
                                        <td class="text-end">
                                            <div class="actions">
                                                <a href="{{ route('admin.manage.edit', $announcement->uuid) }}" class="btn btn-sm bg-danger-light">
                                                    <i class="far fa-edit me-2"></i>
                                                </a>
                                                <a class="btn btn-sm bg-danger-light delete" data-bs-toggle="modal" data-bs-target="#delete" data-uuid="{{ $announcement->uuid }}">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <form action="{{ route('admin.manage.delete') }}" method="POST">
                            @csrf
    ...
    <script>
        $(document).ready(function() {
            $('.show-more').click(function(e) {
                ...
                if ($(this).text() === 'Lihat Selengkapnya') {
                    $(this).text('Tutup');
                } else {
