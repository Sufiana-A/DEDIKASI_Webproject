            ...
            <div class="col-md-12">
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <form method="POST" action="{{ route('profil_photo_submit_admin') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-lg-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('profile_submit_admin') }}">
                                            @csrf
                                            <div class="mb-4 form-group">
                                                <label for="first_name" class="text-muted text-sm-end mb-3 mb-sm-3">First Name</label>
                                                <input type="text" class="form-control col-sm-9" name="first_name" value="{{ Auth::guard('admin')->user()->first_name }}" readonly>
                                            </div>
                                            <div class="mb-4 form-group">
                                                <label for="last_name" class="text-muted text-sm-end mb-3 mb-sm-3">Last Name</label>
                                                <input type="text" class="form-control col-sm-9" name="last_name" value="{{ Auth::guard('admin')->user()->last_name }}" readonly>
                                            </div>
                                            <div class="mb-4 form-group">
                                                <label for="nim" class="text-muted text-sm-end mb-3 mb-sm-3">NIP</label>
                                                <input type="text" class="form-control col-sm-9" name="nip" value="{{ Auth::guard('admin')->user()->nip }}" readonly>
                                            </div>
                                            <div class="mb-4 form-group">
                                            ...
                                            <div class="mb-4 form-group">
                                                ...
                                                <div class="input-group col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control @error('no_hp') is-invalid @enderror" placeholder="8510023841" name="no_hp" value="{{ ltrim(Auth::guard('admin')->user()->no_hp, '0') }}">
                                                    @error('no_hp')
                                                    <div class="text text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
