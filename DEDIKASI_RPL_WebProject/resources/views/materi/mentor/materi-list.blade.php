                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" style="font-size: 20px; font-weight: bold; margin-left: 10px; color:#3d5ee1";>Materi | Course</h4> <br>
                            <h6> > Silakan tambahkan Materi untuk dipelajari Peserta!</h6> <br>
                        </div>    
                        <div class="card-body">
                            ...
                            <br><a href={{ route('materi_create') }} class="btn btn-primary" ><i class="fas fa-add"></i> Tambahkan Materi</a>          
                        </div>
                    </div>
                </div>
            </div>
